...
export default function Register() {
    ...
    const wallet_address = useRef() // New reference for wallet address
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            wallet_address: wallet_address.current.value // Include wallet address in the data
        };
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control'
                           id="wallet_address" ref={wallet_address}/> {/* New input field */}
                </div>
                <div className="mb-3">
